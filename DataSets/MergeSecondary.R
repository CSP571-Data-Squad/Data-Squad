...
data1 <- read.csv("/Users/kevinmouofo/repos/CSP571/DataSets/secondary1/firms-with-female-top-manager-of-firms-bars.csv")
...
str(data1)
code1 <- melt(table(data1["Code"]))[,"Var.1"]



data2 <- read.csv("/Users/kevinmouofo/repos/CSP571/DataSets/secondary1/proportion-of-women-in-senior-and-middle-management-positions.csv")
...
data3 <- read.csv("/Users/kevinmouofo/repos/CSP571/DataSets/secondary1/seats-held-by-women-in-national-parliaments.csv")
...
data4 <- read.csv("/Users/kevinmouofo/repos/CSP571/DataSets/secondary1/youth-literacy-female.csv")
